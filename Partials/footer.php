<?php
    echo '<footer class="footer container" id="footer">
    <div class="footer___container grid">
      <div class="footer__content">
        ...
        <p class="footer__description"><span>Address : </span> 26 Nigdi Pradhikaran</p>
        <p class="footer__description"><span>Phone : </span> 123456787</p>
    ...
    <div class="footer__bottom">
      ...
      <span class="designer">Designed By Vikas Verma</span>
    </div>
  </footer>';
?>